...
browser = webdriver.Chrome(
    "/Users/Mantra/Downloads/chromedriver_win32/chromedriver")
...
def getDataFromHyperlink(hyperlink):
    try:
        ...
        for tr_tag in soup.final_all("tr", attrs={"class": "fact_row"}):
        ...
        time.sleep(1)
        getDataFromHyperlink(hyperlink)

for index,data in enumerate(planets_data):
    getDataFromHyperlink(data[5])
